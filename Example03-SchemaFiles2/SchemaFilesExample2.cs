    ...
    public static void Run()
    {
        Fuzzer.Run(stream =>
        {
            try
            {
                ...
                //File.WriteAllBytes(@"C:\src\FlatSharp\samples\TestCases\TestCases.txt", destination);
                FooBarContainer.Serializer.Parse(Encoding.UTF8.GetBytes(stream));
            }
            catch (Exception)
            {
